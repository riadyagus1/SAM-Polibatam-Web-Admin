...
$sql= mysqli_query($koneksi, "SELECT `tbl_absen_keluar`.`id_header`, `tbl_absen_keluar`.`report`, `tbl_absen_header`.`nim_nik_unit`, `tbl_user`.`name`, `tbl_absen_header`.`tanggal_absen`
FROM `tbl_absen_keluar` 
	LEFT JOIN `tbl_absen_header` ON `tbl_absen_keluar`.`id_header` = `tbl_absen_header`.`id` 
	LEFT JOIN `tbl_user` ON `tbl_absen_header`.`nim_nik_unit` = `tbl_user`.`nim_nik_unit`
WHERE `tbl_absen_header`.`nim_nik_unit` = '$nim_nik_unit' AND `tbl_absen_header`.`tanggal_absen` = '$tanggal_absen';");
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>SAM Polibatam | To Do List</title>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">To Do List</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="Home.php">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="RekapAbsen.php">Rekap Absen</a></li>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Nama: <code><?php foreach($sql as $row){ echo $row['name']; }?></code></h6>
                                <h6 class="card-subtitle">Tanggal: <code><?php foreach($sql as $row){ echo $row['tanggal_absen']; }?></code></h6>
                                <br>
