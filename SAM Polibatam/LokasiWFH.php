                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="text-end upgrade-btn">
                                                        <a href="#"
                                                            class="btn waves-effect waves-light btn-info"><i class="fas fa-location-arrow"></i> Goto Location</a>
                                                        <a href="#"
                                                            class="btn btn-success d-none d-md-inline-block text-white"><i class="fas fa-edit"></i> Edit</a>
                                                        <a href="#"
                                                            class="btn btn-danger d-none d-md-inline-block text-white"><i class="fas fa-trash"></i> Delete</a>
                                                </div></td>
                                            </tr>
                                            <tr>
                                                <td>Batam Centre</td>
